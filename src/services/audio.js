...
(function() {
  console.log('audio recording to start')
  if (!window.AudioContext) {
    console.log('Your browser does not support window.Audiocontext. This is needed for this demo to work. Please try again in a differen browser.');
  }
  ...
  const setAudioStream = streamParam => {
    stream = streamParam;
